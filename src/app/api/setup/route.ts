...
// ──── SQL statements: CREATE TABLE IF NOT EXISTS for every model in schema.prisma ────
// Stored as an array so DO $$ blocks aren't broken by naive semicolon splitting.

const SCHEMA_STATEMENTS = [
  // ── Tables ──
  `CREATE TABLE IF NOT EXISTS "AdminUser" (
    "id" TEXT NOT NULL PRIMARY KEY, "email" TEXT NOT NULL, "passwordHash" TEXT NOT NULL,
    "name" TEXT, "role" TEXT NOT NULL DEFAULT 'admin',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "AdminSession" (
    "id" TEXT NOT NULL PRIMARY KEY, "token" TEXT NOT NULL, "userId" TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS "Article" (
    ...
    "excerpt" TEXT NOT NULL DEFAULT '', "content" TEXT NOT NULL,
    "category" TEXT NOT NULL DEFAULT 'life-reflection', "tags" TEXT NOT NULL DEFAULT '',
    "status" TEXT NOT NULL DEFAULT 'DRAFT', "featured" BOOLEAN NOT NULL DEFAULT false,
    "readTime" INTEGER NOT NULL DEFAULT 0, "coverImage" TEXT, "ogImage" TEXT, "metaDescription" TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS "Book" (
    ...
    "description" TEXT NOT NULL, "proposition" TEXT NOT NULL DEFAULT '', "whyExists" TEXT NOT NULL DEFAULT '',
    "whoFor" TEXT NOT NULL DEFAULT '', "coreIdeas" TEXT NOT NULL DEFAULT '',
    "whatReaderLearns" TEXT NOT NULL DEFAULT '', "keyFrameworks" TEXT NOT NULL DEFAULT '',
    "excerpts" TEXT NOT NULL DEFAULT '', "coverImage" TEXT, "buyLink" TEXT,
    "themeColors" TEXT NOT NULL DEFAULT '{}', "order" INTEGER NOT NULL DEFAULT 0,
  ...
  `CREATE TABLE IF NOT EXISTS "SpeakingEvent" (
    "id" TEXT NOT NULL PRIMARY KEY, "title" TEXT NOT NULL, "eventType" TEXT NOT NULL,
    "audience" TEXT, "location" TEXT, "date" TIMESTAMP(3), "description" TEXT NOT NULL,
    "videoLink" TEXT, "published" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "TeachingEntry" (
    "id" TEXT NOT NULL PRIMARY KEY, "institution" TEXT NOT NULL, "subject" TEXT NOT NULL,
    "level" TEXT, "description" TEXT NOT NULL, "period" TEXT,
    "published" BOOLEAN NOT NULL DEFAULT false, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "ConsultingHighlight" (
    "id" TEXT NOT NULL PRIMARY KEY, "title" TEXT NOT NULL, "client" TEXT,
    "description" TEXT NOT NULL, "recognition" TEXT, "order" INTEGER NOT NULL DEFAULT 0,
    "published" BOOLEAN NOT NULL DEFAULT false, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Venture" (
    "id" TEXT NOT NULL PRIMARY KEY, "name" TEXT NOT NULL, "tagline" TEXT,
    "description" TEXT NOT NULL, "role" TEXT, "website" TEXT, "logoUrl" TEXT,
    "current" BOOLEAN NOT NULL DEFAULT true, "order" INTEGER NOT NULL DEFAULT 0,
    "published" BOOLEAN NOT NULL DEFAULT false, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Recognition" (
    "id" TEXT NOT NULL PRIMARY KEY, "title" TEXT NOT NULL, "organization" TEXT, "year" TEXT,
    "description" TEXT NOT NULL, "order" INTEGER NOT NULL DEFAULT 0,
    "published" BOOLEAN NOT NULL DEFAULT false, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "SiteSetting" (
    "id" TEXT NOT NULL PRIMARY KEY, "key" TEXT NOT NULL, "value" TEXT NOT NULL DEFAULT '',
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "AutoPublishConfig" (
    "id" TEXT NOT NULL PRIMARY KEY, "enabled" BOOLEAN NOT NULL DEFAULT true,
    "postsPerDay" INTEGER NOT NULL DEFAULT 2, "makeWebhookUrl" TEXT NOT NULL DEFAULT '',
    "siteBaseUrl" TEXT NOT NULL DEFAULT 'https://mohamedabukhadra.com',
    "hashtagSuffix" TEXT NOT NULL DEFAULT '', "notifySubscribers" BOOLEAN NOT NULL DEFAULT true,
    "lastRunAt" TIMESTAMP(3), "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "PublishLog" (
    "id" TEXT NOT NULL PRIMARY KEY, "articleId" TEXT NOT NULL, "articleTitle" TEXT NOT NULL,
    "articleSlug" TEXT NOT NULL, "articleCategory" TEXT NOT NULL DEFAULT '',
    "publishedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "webhookSent" BOOLEAN NOT NULL DEFAULT false,
    "webhookStatus" INTEGER, "webhookResponse" TEXT, "emailsSent" INTEGER NOT NULL DEFAULT 0,
    "error" TEXT, "triggeredBy" TEXT NOT NULL DEFAULT 'cron'
  )`,
  `CREATE TABLE IF NOT EXISTS "NewsletterSubscriber" (
    "id" TEXT NOT NULL PRIMARY KEY, "email" TEXT NOT NULL, "name" TEXT,
    "active" BOOLEAN NOT NULL DEFAULT true, "source" TEXT NOT NULL DEFAULT 'site',
    "unsubToken" TEXT NOT NULL, "confirmedAt" TIMESTAMP(3), "unsubscribedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Lead" (
    "id" TEXT NOT NULL PRIMARY KEY, "name" TEXT NOT NULL, "email" TEXT NOT NULL,
    "company" TEXT, "phone" TEXT, "type" TEXT NOT NULL DEFAULT 'contact', "message" TEXT,
    "status" TEXT NOT NULL DEFAULT 'new', "attribution" TEXT NOT NULL DEFAULT '{}',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "SeoMeta" (
    "id" TEXT NOT NULL PRIMARY KEY, "path" TEXT NOT NULL, "title" TEXT, "description" TEXT,
    "ogImage" TEXT, "keywords" TEXT, "jsonLd" TEXT, "noIndex" BOOLEAN NOT NULL DEFAULT false,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Redirect" (
    "id" TEXT NOT NULL PRIMARY KEY, "fromPath" TEXT NOT NULL, "toPath" TEXT NOT NULL,
    "status" INTEGER NOT NULL DEFAULT 301, "enabled" BOOLEAN NOT NULL DEFAULT true,
    "hits" INTEGER NOT NULL DEFAULT 0, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Pageview" (
    "id" TEXT NOT NULL PRIMARY KEY, "sessionId" TEXT NOT NULL, "path" TEXT NOT NULL,
    "referrer" TEXT, "country" TEXT, "device" TEXT, "browser" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "VisitorSession" (
    "id" TEXT NOT NULL PRIMARY KEY, "visitorId" TEXT NOT NULL, "entryPath" TEXT NOT NULL,
    "exitPath" TEXT, "referrer" TEXT, "utmSource" TEXT, "utmMedium" TEXT, "utmCampaign" TEXT,
    "pageviewCount" INTEGER NOT NULL DEFAULT 1, "durationSec" INTEGER NOT NULL DEFAULT 0,
    "country" TEXT, "device" TEXT, "startedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "lastSeenAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "AnalyticsEvent" (
    "id" TEXT NOT NULL PRIMARY KEY, "sessionId" TEXT, "name" TEXT NOT NULL, "path" TEXT,
    "value" DOUBLE PRECISION, "meta" TEXT NOT NULL DEFAULT '{}',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Testimonial" (
    "id" TEXT NOT NULL PRIMARY KEY, "author" TEXT NOT NULL, "role" TEXT, "company" TEXT,
    "content" TEXT NOT NULL, "rating" INTEGER NOT NULL DEFAULT 5, "published" BOOLEAN NOT NULL DEFAULT false,
    "order" INTEGER NOT NULL DEFAULT 0, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "Faq" (
    "id" TEXT NOT NULL PRIMARY KEY, "category" TEXT NOT NULL DEFAULT 'General',
    "question" TEXT NOT NULL, "answer" TEXT NOT NULL, "published" BOOLEAN NOT NULL DEFAULT true,
    "order" INTEGER NOT NULL DEFAULT 0, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "MediaFile" (
    "id" TEXT NOT NULL PRIMARY KEY, "filename" TEXT NOT NULL, "url" TEXT NOT NULL,
    "alt" TEXT, "mime" TEXT NOT NULL DEFAULT '', "size" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  // ── Unique constraints (DO blocks must be kept intact) ──
...
export async function POST() {
  ...
  try {
    ...
    log.push(`  Tables created (${SCHEMA_STATEMENTS.length} SQL statements)`)
