        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px 32px 8px 32px;font-family:Georgia,'Times New Roman',serif;">
              ...
              <h1 style="margin:0 0 12px 0;font-size:24px;line-height:1.3;color:#14161A;font-weight:bold;">${esc(opts.title)}</h1>
              <div style="width:48px;height:3px;background-color:#B4893B;border-radius:2px;margin:0 0 20px 0;"></div>
              <p style="margin:0 0 24px 0;font-size:16px;line-height:1.6;color:#14161A;font-family:Arial,Helvetica,sans-serif;">${esc(opts.excerpt)}</p>
            </td>
          </tr>
      ...
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px 32px 8px 32px;font-family:Georgia,'Times New Roman',serif;">
              <p style="margin:0 0 16px 0;font-size:15px;color:#5C6169;font-family:Arial,Helvetica,sans-serif;">${greeting}</p>
              <h1 style="margin:0 0 12px 0;font-size:24px;line-height:1.3;color:#14161A;font-weight:bold;">${esc(heading)}</h1>
              <div style="width:48px;height:3px;background-color:#B4893B;border-radius:2px;margin:0 0 20px 0;"></div>
              <p style="margin:0 0 24px 0;font-size:16px;line-height:1.6;color:#14161A;font-family:Arial,Helvetica,sans-serif;">${esc(body)}</p>
            </td>
          </tr>
